...
export default function RecievedMessage({ message }: ComponentProps) {
  return (
    <div className="flex flex-row w-full  items-start justify-between duration-150 gap-2 bg-orange-200 p-2 hover:bg-orange-300 hover:cursor-pointer">
      ...
      <div className="flex flex-col gap-2 justify-start items-start text-nowrap">
