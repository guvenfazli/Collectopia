...
export default function UserRegister() {
  ...
  return (
    <div className="flex border bg-gradient-to-br from-orange-200 via-orange-100 to-orange-300 backdrop-blur-md bg-opacity-80 text-orange-800 border-orange-800 w-2/4 py-5 rounded-lg h-auto flex-col items-center justify-center text-center gap-5 max-lg:w-2/3 max-md:w-full">
