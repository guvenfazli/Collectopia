...
export default function UserLogin() {
  ...
  return (
    <div className="flex border border-orange-800 bg-gradient-to-br from-orange-200 via-orange-100 to-orange-300 bg-opacity-80 text-orange-800 w-2/4 rounded-lg h-2/4 flex-col items-center justify-center text-center gap-5 max-lg:w-3/4 backdrop-blur-md">
