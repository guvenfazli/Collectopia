  ...
  useEffect(() => {
    ...
    async function fetchAuction() { // Fetches the whole auction on first enterence.
      ...
      try {
        ...
        setMessageList((resData.fetchedMessages.messages && resData.fetchedMessages.messages.length > 0) ? resData.fetchedMessages.messages.reverse() : []) // Will take a look into this later.
      } catch (err: any) {
        toast({
          title: 'Error!',
