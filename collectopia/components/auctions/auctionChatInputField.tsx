export default function AuctionChatInputField() {
  return (
    <form className="flex w-full justify-between items-center">
      <input required placeholder="Type Your Message" className="placeholder:text-orange-300 p-3 bg-orange-100 border border-orange-800 w-4/5 text-orange-800 font-semibold outline-none" />
